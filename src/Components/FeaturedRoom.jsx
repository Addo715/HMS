    ...
    <div className="bg-gray-100 py-10">
      <div className="mx-4 sm:mx-[10%]">
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <Link to={`/rooms/${room._id}`}>
                      <button 
                        className="bg-white cursor-pointer text-black font-semibold border border-black px-4 py-2 hover:bg-blue-50 transition"
                      >
                        Book Now
                      </button>
                    </Link>
        ...
        <div className="flex justify-center mt-10 pb-10">
          <Link to="/rooms">
            <button 
              className="flex items-center cursor-pointer gap-2 bg-white text-black font-semibold border border-black px-4 py-2 transition"
            >
