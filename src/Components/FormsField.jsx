  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <button 
          type="submit"
          className='w-full md:w-auto flex gap-2 bg-white items-center justify-center text-black font-semibold border border-black px-7 py-2 hover:bg-gray-100 transition cursor-pointer'
        >
          Search
        </button>
      </form>
