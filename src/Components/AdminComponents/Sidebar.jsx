...
const Sidebar = ({ currentRoute, setCurrentRoute, sidebarOpen, setSidebarOpen }) => {
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: <HiOutlineBriefcase size={20} /> },
    { id: 'room-management', label: 'Room Management', icon: <HiOutlineKey size={20} /> },
    { id: 'room-list', label: 'Room List', icon: <HiOutlineDocumentText size={20} /> },
  ];
      ...
      >
        ...
        <div className="p-6 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            {sidebarOpen && (
              <h1 className="text-blue-600 font-bold text-2xl">StayHub</h1>
            )}
          </div>
          ...
          >
            <HiOutlineX size={20} className="text-gray-600" />
          </button>
        </div>
